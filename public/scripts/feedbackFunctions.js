import { getFirestore, where, collection, addDoc, serverTimestamp, query, orderBy, onSnapshot, getDocs } from "https://www.gstatic.com/firebasejs/11.6.0/firebase-firestore.js";
    ...
    if (user) {
        ...
        onSnapshot(feedbackQuery, (snapshot) => {
            ...
            snapshot.forEach((doc) => {
                ...
                : "Pending timestamp";
                feedbackItem.textContent = `${data.feedback} - ${time}`;
